...
SECRET_KEY = 'django-insecure-h!g$m3f5xcejip2()*(!2ysmo@wgc4ugrfzyino(_s&tlry1u1'
...
file_config = BASE_DIR / "secrets" / "postgres_config.ini"
config = configparser.ConfigParser()
config.read(file_config)
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config.get("DEV_DB", "DB_NAME"),
